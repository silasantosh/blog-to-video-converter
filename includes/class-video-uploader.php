...
class BTV_Video_Uploader
{
    ...
    public function handle_upload()
    {
        ...
        if ($movefile && !isset($movefile['error'])) {
            ...
            // Track when video was generated (for outdated detection)
            update_post_meta($post_id, '_btv_video_generated_at', current_time('timestamp'));
            // Clear outdated flag
            delete_post_meta($post_id, '_btv_post_updated_after_video');
